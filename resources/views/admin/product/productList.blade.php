            ...
            <div class="container">
                ...
                <div class="mb-3">
                    <form id="outlet_form" action="product_in_stock" method="get">
                        ...
                        <select style="font-size: 12px; max-width: 300px;" onChange="getTableData()" id="outlet" name="outlet" class="form-select" aria-label="Outlet">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <a  onclick="setProductDeteiles({{$product}})" class="btn btn-success text-white" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-edit"></i></a>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input id="offer_mrp" onchange="expireDateFild('offer_mrp')"  type="number" step="0.01" class="form-control @error('offer_mrp') is-invalid @enderror" name="offer_mrp" value="{{ old('offer_mrp') }}" autocomplete="offer_mrp" autofocus>
                                        ...
                                        <div id="expire_div" class="col d-none">
                                            ...
                                            <input id="expire_date" onchange="numberInputTracking('expire_date')"  type="date" class="form-control @error('expire_date') is-invalid @enderror" name="expire_date" value="{{ old('expire_date') }}" autocomplete="expire_date" autofocus>
